...
![Technology](https://github.com/)
![EDA](https://www.cadence.com/)
![Simulator](https://www.cadence.com/)
![Frequency](https://github.com/)
Overview
...
Regenerative latch
Pre-charge/reset network
Tail control
LECTOR leakage-control transistor pairs
...
See `results/` for machine-readable CSV data.
---
